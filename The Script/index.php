    ...
    <div class="container">
      ...
      <div class="col-lg-9 offset-lg-2 col-12 comment-main rounded">
        ...
        <table width="100%" align="center">
          <tr>
            <td width="10%">
              <input type="radio" name="avater" value="boy.png" required><img src="image/boy.png" width="40">
              <input type="radio" name="avater" value="girl.png" required><img src="image/girl.png" width="40">
            </td>
        </tr>
        </table>
        </div>
