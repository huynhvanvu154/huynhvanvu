	...
	<div class="row">
		...
		<div class="col-12 col-lg-9 section">
			<div class="row">
				...
				<form class=" row" action="" method="GET" class="" role="form" style="width: auto; margin-top: 10px; padding: 0; margin: auto;">
					<h3 class="col-12" style="text-align: center; color: #0000FF">
						<strong>DANH SÁCH BỆNH NHÂN</strong>
					</h3>
					<table class="col-12" border="1px;" style="max-with: 98%">
						<thead>
