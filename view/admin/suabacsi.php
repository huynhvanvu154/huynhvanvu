		...
		<div class="col-12 col-lg-9 menu-right ">
			<ul  class="section row" >
				<div class="col-12">
					...
					?>
					<legend style="text-align: center; color: red;"> Cập Nhật Bác Sĩ!</legend>
					<form action="" method="post" class="form" role="form" style="width: 250px; margin: auto; "> 
						<div class="row"> 
							<input class="form-control" name="name" placeholder="Họ Và Tên" value="<?php echo $data_bacsi['name']?>">
							<input class="form-control" name="email" placeholder="Email" value="<?php echo $data_bacsi['email']?>"> 
							<input class="form-control" name="sex" placeholder="Giới Tính" value="<?php echo $data_bacsi['sex']?>">
							<input class="form-control" name="birtday" placeholder="Ngày Sinh" value="<?php echo $data_bacsi['birtday']?>">

							<input class="form-control" name="address" placeholder="Địa Chỉ" value="<?php echo $data_bacsi['address']?>"> 
							<input class="form-control" name="sdt" placeholder="Liên Hệ" value="<?php echo $data_bacsi['sdt']?>"> 
