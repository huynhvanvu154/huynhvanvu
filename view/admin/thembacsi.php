								...
								<div class="row"> 
									<div class="col-12">
										<?php 
												...
												echo '<p><b style ="color: red; text-align: center; margin-left:280px;" >CẤP TÀI KHOẢN BÁC SĨ THÀNH CÔNG THÀNH CÔNG!!!</b></p>';
												}else{
												echo '<p style ="color: red"; "text-align: center" > </p>';

												}
											 ?>
									 <legend style="text-align: center;"> Cấp Tài Khoản Cho Bác Sĩ!</legend>
									 <a href="http://localhost/quanlybenhnhan/index.php?controller=admin&action=danhsachbacsi" style="text-decoration: none; float: right; margin-right: 230px; margin-top: -35px"> Danh Sách Bác Si </a>
